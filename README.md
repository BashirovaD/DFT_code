...
In this section, we use Python code to calculate the standard 3D PIB solutions for boxes of user-specified dimensions. The eigenenergies and eigenstates can be visualized as an interactive energy diagram and isosurface renderings, respectively. <br />(https://github.com/BashirovaD/DFT_code/blob/main/figures/NB1_wavefunction.png) <br />
